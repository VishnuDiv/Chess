...
public class Game {
    ...
    /**
     * This checks if the format for the input of the moves is correct and splits the input to make it
     * easy for the program to read
     * 
     * @param move input of the terminal. Reads the startposition and endposition of the piece
    ...
    /**
     * This method essentially checks if the move is possible and if it's possible it will move the piece on the board
    ...
    public void move(Pair startPos, Pair endPos){
        //Create a new test Board to b for invalid moves so that you don't mess with the real board while checking
        ...
        if(game[startPos.x][startPos.y] == null){ 
            ...
            if(game[startPos.x][startPos.y].getPiece().potentialMoves.contains(endPos)){ 
                ...
                if(enPassent && testGame[endPos.x][endPos.y] == null){
                    ...
                    if(startPos.equals(new Pair(4, 7)) && endPos.equals(new Pair(2, 7))){ 
                        ...
                        && lastPawn.equals(new Pair(startPos.x-1, startPos.y))){ //black pawn
                            //bottom left
                            if((testGame[startPos.x-1][startPos.y]!=null) && testGame[startPos.x-1][startPos.y].getPiece() instanceof Pawn && testGame[startPos.x-1][startPos.y].getPiece().isWhite() == true){
                        ...
                        && lastPawn.equals(new Pair(startPos.x-1, startPos.y))){ //white pawn
                            //top left
                            if((testGame[startPos.x-1][startPos.y]!=null) && testGame[startPos.x-1][startPos.y].getPiece() instanceof Pawn && testGame[startPos.x-1][startPos.y].getPiece().isWhite() == false){
                                testGame[startPos.x-1][startPos.y] = null;
                ...
                if(isCheck(testGame)){ 
                    ...
                    if((game[startPos.x][startPos.y] != null) && game[startPos.x][startPos.y].getPiece() instanceof King){
                    ...
                    if((game[startPos.x][startPos.y] != null) && game[startPos.x][startPos.y].getPiece() instanceof Rook){
...
/**
     * This method promotes a pawn to another piece if it reaches the end of the board
     * 
     ...
     */
    //if pawn reaches opposite side of board, promote it
    ...
    public void setValidPieceMoves(Space[][] testGame){
        ...
        for(int i = 0; i < testGame.length-1;i++){
            if (testGame[i][3] != null && testGame[i][3].getPiece() instanceof Pawn && testGame[i][3].getPiece().isWhite() == false 
            && testGame[i+1][3] != null && testGame[i+1][3].getPiece() instanceof Pawn && testGame[i+1][3].getPiece().isWhite() == true && testGame[i+1][2] == null 
            && nextTurn == true
            ...
            if (testGame[i+1][3] != null && testGame[i+1][3].getPiece() instanceof Pawn && testGame[i+1][3].getPiece().isWhite() == false 
            && testGame[i][3] != null && testGame[i][3].getPiece() instanceof Pawn && testGame[i][3].getPiece().isWhite() == true && testGame[i][2] == null 
            && nextTurn == true
            ...
            if (testGame[i][4] != null && testGame[i][4].getPiece() instanceof Pawn && testGame[i][4].getPiece().isWhite() == true 
            && testGame[i+1][4] != null && testGame[i+1][4].getPiece() instanceof Pawn && testGame[i+1][4].getPiece().isWhite() == false && testGame[i+1][5] == null 
            && nextTurn == true
            ...
            if (game[i+1][4] != null && game[i+1][4].getPiece() instanceof Pawn && game[i+1][4].getPiece().isWhite() == true 
            && game[i][4] != null && game[i][4].getPiece() instanceof Pawn && game[i][4].getPiece().isWhite() == false && game[i][5] == null 
            && nextTurn == true
        ...
        if(game[4][7] != null && game[4][7].getPiece() instanceof King){ //White left Castle
            ...
            if(k.moved == false){
                ...
                if((game[0][7]!=null) && game[0][7].getPiece() instanceof Rook && game[1][7] == null && game[2][7] == null && game[3][7] == null && (!attacked(new Pair(1,7))) && (!attacked(new Pair(2,7))) && (!attacked(new Pair(3,7)))){
                ...
                if((game[7][7]!=null) && game[7][7].getPiece() instanceof Rook && game[5][7] == null && game[6][7] == null && (!attacked(new Pair(5,7))) && (!attacked(new Pair(6,7)))){ //White Right Castle
        ...
        if(game[4][0] != null && game[4][0].getPiece() instanceof King){ //white left Castle
            ...
            if(k.moved == false){
                if((game[0][0] != null) && game[0][0].getPiece() instanceof Rook && game[1][0] == null && game[2][0] == null && game[3][0] == null && (!attacked(new Pair(1,0))) && (!attacked(new Pair(2,0))) && (!attacked(new Pair(3,0)))){
                ...
                if((game[7][0] != null) && game[7][0].getPiece() instanceof Rook && game[5][0] == null && game[6][0] == null && (!attacked(new Pair(5,0))) && (!attacked(new Pair(6,0)))){ //Black Right Castle
                        ...
                        for(Pair pair : valid){
                            ...
                            if(game[i][j].getPiece().isWhite() != checkingPiece.getPiece().isWhite()){
                                if(game[i][j].getPiece() instanceof King){ //can king move to a safe space
                                    ...
                                    if(attacked(pair)==false) return false;
                                }
                            }
                        }
                    }
    ...
    /**
     *This method essentially checks if the king is under check or is being attacked in any way shape or form
     *
    ...
    public boolean isCheck(Space[][] testGame){
        ...
        for(int i = 0; i < testGame.length; i++) {
            for (int j = 0; j < testGame[i].length; j++) {
                ...
                //finds your king
                if((testGame[i][j]!=null) && (testGame[i][j].getPiece() instanceof King) && color == testGame[i][j].getPiece().isWhite()){
        ...
        for (Space[] pieces : testGame) {
            for (Space piece : pieces) {
                ...
                if (piece!=null){
               // System.out.println(piece.getPiece() + " " + piece.getPiece().potentialMoves.contains(allyKingPos) );
                }
                if(piece != null){
                    if ((piece.getPiece().isWhite() != allyKingCol) && piece.getPiece().potentialMoves.contains(allyKingPos)){
    ...
    public boolean pawnCapture(Pair start, Pair end) {
        ...
        if(testGame[startx][starty].getPiece().isWhite() == true){
            if(endy == starty-1 && (endx == startx+1 || endx == startx-1)){
                 if(testGame[endx][endy] == null && (testGame[endx][endy+1].getPiece() instanceof Pawn) && testGame[endx][endy+1].getPiece().isWhite() == false) {
            ...
            if(endy == starty+1 && (endx == startx+1 || endx == startx-1)){
                if(testGame[endx][endy] == null && (testGame[endx][endy-1].getPiece() instanceof Pawn) && testGame[endx][endy-1].getPiece().isWhite() == true) {
                    Pawn temp = (Pawn) testGame[endx][endy-1].getPiece();
                    if(temp.twoMove){
                        game[startx][starty].getPiece().potentialMoves.add(new Pair(endx,endy));
                        return true;
    ...
    /**
     * this method takes in the character being used in the command line and converts
     * it to an int 
     *
